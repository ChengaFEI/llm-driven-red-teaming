...
from redteam.generators.questions.toxic_conversational_generator import ToxicConversationalGenerator  # noqa: E501
from redteam.generators.questions.toxic_question_generator import ToxicQuestionGenerator  # noqa: E501
...
class ToxicitySimulator:
    def __init__(
        ...
        self.initial_question = \
            self.initial_generator.generate(context=self.context)
        self.data_list = []
        self.eval_path = eval_path
        if eval_path is None:
            self.eval_path = \
                f"data/examples/{str(self.__class__.__name__)}_simulation.json"
